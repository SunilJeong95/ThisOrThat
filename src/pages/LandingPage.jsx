    ...
    <footer className="relative z-10 bg-slate-50 py-12 px-6 border-t border-slate-200">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <Link className="text-slate-500 hover:text-[#0EA5E9] transition-colors text-sm font-medium" to="/how-it-works">How It Works</Link>
          <Link className="text-slate-500 hover:text-[#0EA5E9] transition-colors text-sm font-medium" to="/faq">FAQ</Link>
